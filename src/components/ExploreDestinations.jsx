...
//   return (
//     <section className="flex mt-8 flex-col gap-8 w-full">
//       {/* Heading */}
//       <div className="px-8 flex flex-col gap-2 max-w-6xl">
//         <h2 className="text-3xl md:text-4xl font-bold text-black">
//           Explore Full Destination at Half-Price Tag
//         </h2>
//         <p className="text-[#4E4E4E] text-lg md:text-xl font-normal max-w-[1200px]">
...
//           style={{
//             backgroundImage: `linear-gradient(0deg, rgba(0,0,0,0.4), rgba(0,0,0,0.4)), url(${slides[current].image})`,
//           }}
//         ></div>
...
//         <button
//           onClick={prevSlide}
//           className="absolute left-4 top-1/2 -translate-y-1/2 bg-black/60 hover:bg-black/80 w-10 h-10 rounded-full flex items-center justify-center transition"
//         >
...
//         <button
//           onClick={nextSlide}
//           className="absolute right-4 top-1/2 -translate-y-1/2 bg-black/60 hover:bg-black/80 w-10 h-10 rounded-full flex items-center justify-center transition"
//         >
//           <ChevronRight className="text-white w-5 h-5" />
//         </button>

//         {/* Left Panel (Months + Description) */}
//         <div className="absolute left-14 top-14 flex gap-12">
//           {/* Month List */}
...
//                 className={`text-white text-xl font-semibold transition pb-1 border-b-2 ${
...
//           <div className="w-[380px] bg-[#DC3545]/85 p-6 flex flex-col gap-6 h-[310px]">
...
//                   </h3>
//                   <div className="w-12 h-[3px] bg-white mt-1"></div>
//                 </div>
//               </div>
...
//               className={`w-[30px] h-[6px] rounded-full cursor-pointer transition ${
  ...
  return (
    <section className="flex flex-col gap-8 mt-8 w-full">
      ...
      <div className="relative w-full h-[380px] sm:h-[450px] md:h-[550px] lg:h-[650px] overflow-hidden bg-white">
        ...
        <button
          onClick={prevSlide}
          className="absolute left-2 sm:left-4 top-1/2 -translate-y-1/2 bg-black/60 hover:bg-black/80 w-8 h-8 sm:w-10 sm:h-10 rounded-full flex items-center justify-center transition"
        >
        ...
        <button
          onClick={nextSlide}
          className="absolute right-2 sm:right-4 top-1/2 -translate-y-1/2 bg-black/60 hover:bg-black/80 w-8 h-8 sm:w-10 sm:h-10 rounded-full flex items-center justify-center transition"
        >
        ...
        <div className="absolute left-4 sm:left-10 md:left-14 top-6 sm:top-10 flex flex-col sm:flex-row gap-6 sm:gap-10 md:gap-12">
          ...
          {/* Destination Info Box */}
          <div className="w-[85vw] sm:w-[320px] md:w-[380px] bg-[#DC3545]/85 p-4 sm:p-6 flex flex-col gap-4 sm:gap-6 h-auto sm:h-[310px] rounded-md backdrop-blur-sm">
